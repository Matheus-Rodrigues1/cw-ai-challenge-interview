-- Run once on an existing database if views are missing (e.g. DB created before init.sql included views).
-- Usage: psql -U admin -d cloudwalk_transactions -f sql/create_monitoring_views.sql
